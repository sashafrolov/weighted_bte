...
/// dedicated tag.  Non-identity elements receive a different tag followed by
/// their canonical compressed encoding.  Transcript and batch-digest callers
/// must use this helper rather than calling `write_compressed` directly.
